...
2. `docs/filmtone/filmtone-effect-terminology-alignment-handoff-2026-04-26-jst.md` (このチャットを起こした handoff) の §2 pre-flight、§3 file-by-file checklist、§4 verification に沿って実装。
...
- iOS release runbook: `docs/filmtone/ios/filmtone-ios-v1.1-release-handoff-2026-04-25-jst.md`
