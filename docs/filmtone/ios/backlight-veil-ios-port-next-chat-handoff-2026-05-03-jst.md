...
| `docs/filmtone/desktop/backlight-veiling-glare-implementation-plan-2026-05-03-jst.md` | Phase 1 / 2 / 3 / 4 / 5 全体計画 (origin handoff doc) |
...
>
> 前提となる canonical doc:
> - 本 handoff: `docs/filmtone/ios/backlight-veil-ios-port-next-chat-handoff-2026-05-03-jst.md` (このファイル) ─ §0 / §2 / §5 / §6 を必ず読む。
> - Desktop Phase 1 計画書: `docs/filmtone/desktop/backlight-veiling-glare-implementation-plan-2026-05-03-jst.md`
