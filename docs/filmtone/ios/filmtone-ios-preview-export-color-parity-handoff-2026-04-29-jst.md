...
Read docs/filmtone/ios/filmtone-ios-preview-export-color-parity-handoff-2026-04-29-jst.md first, then inspect only the active files it references before editing.
...
- There is an unrelated untracked handoff doc docs/filmtone/ios/filmtone-ios-lut-intensity-slider-handoff-2026-04-29-jst.md; do not include it unless explicitly asked.
```
