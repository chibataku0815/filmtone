...
2. `docs/filmtone/desktop/native-desktop-v2/active.md` if present
...
For the live state, trust
`docs/filmtone/desktop/native-desktop-v2/strategy.md` and the current
`active.md` if present over this file.
