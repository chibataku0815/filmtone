...
5. **Phase 2 C1+C2+C3 scaffold の元になった predecessor 記録** (深掘り時のみ):
   ...
   - `docs/filmtone/desktop/archive/native-desktop-v2-legacy-2026-05-03/filmtone-native-desktop-phase1c-master-handoff-2026-05-03-jst.md` — Phase 1c 開始時 master
...
#   ?? docs/filmtone/desktop/archive/native-desktop-v2-legacy-2026-05-03/filmtone-native-desktop-phase{1b,1c,2}-...handoff...
