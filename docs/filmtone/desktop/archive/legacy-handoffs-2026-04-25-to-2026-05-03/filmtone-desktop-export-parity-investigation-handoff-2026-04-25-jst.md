...
まずは docs/filmtone/desktop/archive/legacy-handoffs-2026-04-25-to-2026-05-03/filmtone-desktop-export-parity-investigation-handoff-2026-04-25-jst.md を読んで、現在の working tree の変更を把握してください。ユーザー変更を消さないでください。git reset --hard や checkout で戻さないでください。
```
