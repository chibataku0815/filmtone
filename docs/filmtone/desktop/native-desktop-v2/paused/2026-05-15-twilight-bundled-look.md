...
## Paused (2026-05-15) — black-point/toe lane 差し込みのため

復帰時は `paused/2026-05-15-twilight-bundled-look.md` を `active.md` に戻し、Unexpected/Follow-up セクションから再開する。下記 Done 条件のうち xcodebuild / Simulator 視覚確認 / commit が user 承認待ち。
