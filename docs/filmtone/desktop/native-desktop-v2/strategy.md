...
- 2026-05-16 JST: Desktop editing rail Quick axes were replaced with inline
  Adjust parameters. Built-in Look application no longer duplicates catalog
  patches into live user overrides, so direct parameter edits own the surface.
- 2026-05-16 JST: Native Desktop v1.9 public release completed. Public update
