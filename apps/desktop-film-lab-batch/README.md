...
バッチタブ下部の **「動画を書き出す」** が利用できます。入力は最大 **3840×2160・900 秒**、出力は最大 **1920×1080・24fps**（アップスケールなし）。バッチ用ルック（プリセット / JSON）がそのまま適用されます。動画は **編集タブに近い見え方** になるよう、**1 フレームずつグレードして MP4** にします（クリップが長いと完了まで時間がかかります）。
