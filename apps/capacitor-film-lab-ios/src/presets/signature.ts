...
export const SIGNATURE_PRESET_BUNDLE_NOTE = [
  ...
  "Source profiles are handled native (Apple Log / Apple Log 2) + synthesized (D-Log / C-Log / V-Log / S-Log3 via FilmtoneSourceProfileMath) + Rec.709 default. Imported .cube remains as a user-side option.",
