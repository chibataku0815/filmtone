...
const appCopy = {
  en: {
    ...
    lutInputSlotDescription: "Translate log footage (D-Log, C-Log, S-Log3, V-Log, Apple Log) before the look.",
    ...
    cameraProfileDlog: "DJI D-Log",
    cameraProfileDlogM: "DJI D-Log M",
    cameraProfileClog: "Canon C-Log",
    cameraProfileClog3CineGamut: "Canon Log 3 / Cinema Gamut",
  ...
  ja: {
    ...
    lutInputSlotDescription: "D-Log / C-Log / S-Log3 / V-Log / Apple Log などの log 動画を、ルック適用前に変換します。",
