...
import {
  ...
  type FilmLabCanvasPreviewFrameCaptureOptions,
  type FilmLabCanvasPreviewFrameCaptureResult,
...
export type {
  ...
  FilmLabCanvasExportParityGeometry,
  FilmLabCanvasPreviewFrameCaptureOptions,
  FilmLabCanvasPreviewFrameCaptureResult,
