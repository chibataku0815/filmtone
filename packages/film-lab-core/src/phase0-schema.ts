...
export const phase0ParamsSchema = z.object({
  ...
  detailSoftness: z.number().min(0).max(1).default(PRESETS.reset.detailSoftness),
  ...
  filmBreathAmount: z.number().min(0).max(1).default(PRESETS.reset.filmBreathAmount),
  dustAmount: z.number().min(0).max(1).default(PRESETS.reset.dustAmount),
  scratchAmount: z.number().min(0).max(1).default(PRESETS.reset.scratchAmount),
  fade: z.number().min(0).max(1).default(PRESETS.reset.fade),
  shadowTone: z.number().min(0).max(1).default(PRESETS.reset.shadowTone),
  shadowLatitude: z.number().min(0).max(1).default(PRESETS.reset.shadowLatitude),
  blackPoint: z.number().min(-1).max(1).default(PRESETS.reset.blackPoint),
  toeContrast: z.number().min(0).max(1).default(PRESETS.reset.toeContrast),
...
const phase0ParamsPatchSchema = z.object({
  ...
  detailSoftness: z.number().min(0).max(1).optional(),
  ...
  filmBreathAmount: z.number().min(0).max(1).optional(),
  dustAmount: z.number().min(0).max(1).optional(),
  scratchAmount: z.number().min(0).max(1).optional(),
  fade: z.number().min(0).max(1).optional(),
  shadowTone: z.number().min(0).max(1).optional(),
  shadowLatitude: z.number().min(0).max(1).optional(),
  blackPoint: z.number().min(-1).max(1).optional(),
  toeContrast: z.number().min(0).max(1).optional(),
