...
export const DETAIL_SOFTNESS_EFFECTIVE_MAX = 0.34;

const DETAIL_SOFTNESS_KERNEL_RADIUS_MIN = 0.55;
const DETAIL_SOFTNESS_KERNEL_RADIUS_MAX = 1.45;
const DETAIL_SOFTNESS_CHROMA_ATTEN_SCALE = 0.85;
