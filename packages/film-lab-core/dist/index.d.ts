...
interface FilmBreathOffsets {
    exposure: number;
    contrast: number;
    temperature: number;
    tint: number;
}
declare const FILM_BREATH_ZERO_OFFSETS: FilmBreathOffsets;
declare function deriveFilmBreathOffsets(amount: number, timeSeconds: number, sourceSeed: number): FilmBreathOffsets;
...
declare const phase0ParamsSchema: z.ZodObject<{
    ...
    blackPoint: z.ZodDefault<z.ZodNumber>;
    toeContrast: z.ZodDefault<z.ZodNumber>;
...
declare const phase0ProjectSchema: z.ZodPipe<z.ZodObject<{
    ...
    params: z.ZodObject<{
        ...
        blackPoint: z.ZodOptional<z.ZodNumber>;
        toeContrast: z.ZodOptional<z.ZodNumber>;
    ...
    presetName: "reset" | "cinematic" | "portra" | "gold200" | "pro400h" | "bw" | "ektar100" | "superia400" | "cinestill800t" | "vision3500t" | "velvia50";
    params: Phase0Params;
    inputLut: {
        title: string;
        size: number;
    ...
    params: {
        ...
        blackPoint?: number | undefined;
        toeContrast?: number | undefined;
...
declare const BAKE_COLOR_PARAM_KEYS: readonly ["exposure", "contrast", "saturation", "temperature", "tint", "toeContrast", "blackPoint", "fade", "compressionAmount", "compressionRange", "printContrast", "cyan", "magenta", "yellow"];
/**
 ...
 */
declare function applyStoneDisplayPalermoTransform(sourceCube: CreativeCube): CreativeCube;
/**
...
declare const CREATIVE_PACK_01_EXPECTED_PROCESS_SPACE: "display-rec709-normalized";
type CreativePack01ExpectedProcessSpace = typeof CREATIVE_PACK_01_EXPECTED_PROCESS_SPACE;
...
interface FilmCompressionRgb {
    r: number;
    g: number;
    b: number;
}
interface FilmCompressionV3Options {
    clampOutput?: boolean;
}
declare const FILM_COMPRESSION_V3_CONSTANTS: {
    readonly lumaKMin: 2.85;
    readonly lumaKMax: 5.15;
    readonly rangeSoftStart: 0.82;
    readonly rangeSoftEnd: 1;
    readonly rangeAmountTrim: 0.18;
    readonly chromaCompressionMax: 0.42;
    readonly problemColorGuardMax: 0.22;
    readonly shadowReleaseStart: 0.14;
    readonly shadowReleaseEnd: 0.3;
    readonly highlightKneeStartLowRange: 0.62;
    readonly highlightKneeStartHighRange: 0.42;
    readonly highlightKneeEndLowRange: 0.96;
    readonly highlightKneeEndHighRange: 0.78;
    readonly chromaStressStart: 0.16;
    readonly chromaStressEnd: 0.7;
    readonly gamutStressStart: 0.82;
    readonly gamutStressEnd: 1.08;
    readonly warmProtectStrength: 0.35;
    readonly highlightDensityLandingStart: 0.78;
    readonly highlightDensityLandingStrength: 0.88;
    readonly highlightDensityLandingChromaStart: 0.18;
    readonly highlightDensityLandingChromaEnd: 0.62;
    readonly highlightDensityLandingWarmProtect: 0.35;
};
declare function filmCompressionLuma(rgb: FilmCompressionRgb): number;
declare function filmCompressionChromaMagnitude(rgb: FilmCompressionRgb): number;
declare function applyFilmCompressionV3Sample(rgb: FilmCompressionRgb, amount: number, range: number, options?: FilmCompressionV3Options): FilmCompressionRgb;

interface ShadowLatitudeRgb {
    r: number;
    g: number;
    b: number;
}
interface ShadowLatitudeOptions {
    clampOutput?: boolean;
}
declare const SHADOW_LATITUDE_CONSTANTS: {
    readonly blackAnchor: 0.025;
    readonly mainBandStart: 0.055;
    readonly mainBandEnd: 0.18;
    readonly releaseEnd: 0.3;
    readonly lumaGainMax: 0.22;
    readonly chromaRetentionMax: 0.08;
};
declare function shadowLatitudeLuma(rgb: ShadowLatitudeRgb): number;
declare function applyShadowLatitudeSample(rgb: ShadowLatitudeRgb, amount: number, options?: ShadowLatitudeOptions): ShadowLatitudeRgb;
