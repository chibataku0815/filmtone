...
var GpuContextCreationError = class extends Error {
  cause;
...
var GpuContext = class _GpuContext {
   ...
   */
  canvasFormat = "rgba8unorm-srgb";
  validation;
  lost = false;
  lossInfo = null;
  lossListeners = /* @__PURE__ */ new Set();
  constructor(adapter, device, canvas, context, validation) {
    ...
    this.capabilities = Object.freeze({
      ...
      maxTextureDimension2D: typeof adapter.limits.maxTextureDimension2D === "number" ? adapter.limits.maxTextureDimension2D : 8192
    });
  ...
  static async create(canvas, opts = {}) {
    ...
    return new _GpuContext(adapter, device, canvas, context, opts.validation ?? false);
  }
  /** Wrap a pipeline-creating callback with validation error scope. */
  async withValidationScope(fn) {
...
// src/webgpu/WebGPUBackend.ts
import {
  deriveDetailSoftnessUniforms
} from "film-lab-core";

// src/webgpu/MediaTexture.ts
var DEFAULT_MEDIA_USAGE = GPUTextureUsage.TEXTURE_BINDING | GPUTextureUsage.COPY_DST | GPUTextureUsage.RENDER_ATTACHMENT;
var MediaTexture = class {
  static createPlaceholder(device, opts = {}) {
  ...
  static fromImageBitmap(device, bitmap, opts = {}) {
   ...
   */
  static fromVideoElement(device, video, target, opts = {}) {
    const width = video.videoWidth || 1;
    const height = video.videoHeight || 1;
    const needsAlloc = !target || target.width !== width || target.height !== height;
    const texture = needsAlloc ? device.createTexture({
  ...
  static fromExternalImageSource(device, source, width, height, target, opts = {}) {
    const safeWidth = Math.max(1, Math.round(width));
    const safeHeight = Math.max(1, Math.round(height));
    const needsAlloc = !target || target.width !== safeWidth || target.height !== safeHeight;
    const texture = needsAlloc ? device.createTexture({
...
// src/webgpu/OffscreenTargetPool.ts
var DEFAULT_OFFSCREEN_USAGE = GPUTextureUsage.RENDER_ATTACHMENT | GPUTextureUsage.TEXTURE_BINDING | GPUTextureUsage.COPY_SRC;
var OffscreenTargetPool = class {
  constructor(device) {
    this.device = device;
  }
  ...
  get(label, desc) {
    ...
    if (existing && existing.descriptor.width === desc.width && existing.descriptor.height === desc.height && existing.descriptor.format === format && existing.descriptor.mipLevelCount === mipLevelCount && existing.descriptor.sampleCount === sampleCount && existing.descriptor.usage === usage) {
   ...
   */
  pyramid(labelPrefix, fullWidth, fullHeight, levels, desc = {}) {
    const out = [];
...
// src/webgpu/Lut3DTexture.ts
var BYTES_PER_TEXEL_RGBA16F = 8;
var ALIGN_BYTES_PER_ROW = 256;
...
function floatToHalf(f) {
  ...
  if (exponent === 255) {
    return sign | 31744 | (mantissa ? 512 : 0);
  }
  exponent -= 127 - 15;
  ...
  if (exponent <= 0) {
    ...
    if (mantissa & 4096) mantissa += 8192;
...
var Lut3DTexture = class {
   ...
   */
  static upload(device, data, size, opts = {}) {
...
// src/webgpu/assets/blue-noise-256.ts
var BLUE_NOISE_256_SIZE = 256;
var HEX = "";
var BLUE_NOISE_256_BYTES = (() => {
...
// src/webgpu/BlueNoiseTile.ts
var BlueNoiseTile = class {
  /**
...
// src/webgpu/RingBuffer.ts
var MOTION_BLUR_RING_SLOTS = 8;
var DEFAULT_FORMAT = "rgba16float";
...
// src/webgpu/shaders/fullscreen.vert.wgsl.ts
var fullscreenVertexWgsl = (
  /* wgsl */
  `
struct VsOut {
...
// src/webgpu/shaders/bloom-prefilter.frag.wgsl.ts
var bloomPrefilterFragmentWgsl = (
  /* wgsl */
  `
struct Params {
  threshold: f32,
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  // Guard pow/log/sqrt inputs per DIRECTION \xA73 (no negative luma).
...
// src/webgpu/shaders/halation-prefilter.frag.wgsl.ts
var halationPrefilterFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/diffusion-depth-prefilter.frag.wgsl.ts
var diffusionDepthPrefilterFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/bloom-depth-prefilter.frag.wgsl.ts
var bloomDepthPrefilterFragmentWgsl = (
  /* wgsl */
  `
struct Params {
  // (gain, fitMode, rayAngleGain, rayAngleGamma)
...
// src/webgpu/shaders/halation-depth-prefilter.frag.wgsl.ts
var halationDepthPrefilterFragmentWgsl = (
  /* wgsl */
  `
struct Params {
  // (gain, fitMode, rayAngleGain, rayAngleGamma)
...
// src/webgpu/shaders/downsample.frag.wgsl.ts
var downsampleFragmentWgsl = (
  /* wgsl */
  `
struct Params {
  // (texelSize.xy, _, _)
...
// src/webgpu/shaders/upsample.frag.wgsl.ts
var upsampleFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/lightshafts.frag.wgsl.ts
var lightshaftsFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/lightshafts-blend.frag.wgsl.ts
var lightshaftsBlendFragmentWgsl = (
  /* wgsl */
  `
struct Params {
  // (intensity, _, _, _)
...
// src/webgpu/shaders/halo-prism.frag.wgsl.ts
var haloPrismFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/dust.frag.wgsl.ts
var dustFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/filmlab.frag.wgsl.ts
var filmlabFragmentWgsl = (
  /* wgsl */
  `
struct Grade {
...
// Reinhard soft-shaper \u2014 DIRECTION \xA73 HDR-boundary entry. Smoothly
...
// lookup instead of hard-clipping at 1.0. k = 0.5 fixed (DIRECTION \xA710
...
// \xA72 "no clamp in intermediate stages".
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  // shared sampler (DIRECTION \xA710 Phase 2) so the 0..1 domain is safe.
...
// src/webgpu/shaders/blit.frag.wgsl.ts
var blitFragmentWgsl = (
  /* wgsl */
  `
...
// src/webgpu/shaders/compare-source.frag.wgsl.ts
var compareSourceFragmentWgsl = (
  /* wgsl */
  `
...
// src/webgpu/shaders/composite.frag.wgsl.ts
var compositeFragmentWgsl = (
  /* wgsl */
  `
struct Composite {
...
// src/webgpu/shaders/detail-softness.frag.wgsl.ts
var detailSoftnessFragmentWgsl = (
  /* wgsl */
  `
...
// src/webgpu/shaders/motionblur-feedback.frag.wgsl.ts
var motionblurFeedbackFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/motionblur-blend.frag.wgsl.ts
var motionblurBlendFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  for (var i: i32 = 0; i < 8; i = i + 1) {
    ...
    // pair in [0..7] \xD7 [0..7]; the % 8 then wraps cleanly.
...
// src/webgpu/shaders/cross-filter-source.frag.wgsl.ts
var crossFilterSourceFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/cross-filter-peak.frag.wgsl.ts
var crossFilterPeakFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/cross-filter-peak-spacing-max.frag.wgsl.ts
var crossFilterPeakSpacingMaxFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/cross-filter-peak-spacing.frag.wgsl.ts
var crossFilterPeakSpacingFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/cross-filter-streak.frag.wgsl.ts
var crossFilterStreakFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
// src/webgpu/shaders/cross-filter-temporal.frag.wgsl.ts
var crossFilterTemporalFragmentWgsl = (
  /* wgsl */
  `
struct Params {
  // (decay, _, _, _)
...
// src/webgpu/shaders/cross-filter-blend.frag.wgsl.ts
var crossFilterBlendFragmentWgsl = (
  /* wgsl */
  `
struct Params {
...
var GRADE_UNIFORM_FLOATS = 36;
var GRADE_UNIFORM_BYTES = GRADE_UNIFORM_FLOATS * 4;
function packGradeUniforms(state, out = new Float32Array(GRADE_UNIFORM_FLOATS)) {
...
// src/webgpu/compositeUniforms.ts
import { clampGrainIntensity } from "film-lab-core";
var COMPOSITE_UNIFORM_FLOATS = 32;
var COMPOSITE_UNIFORM_BYTES = COMPOSITE_UNIFORM_FLOATS * 4;
var ABERRATION_EDGE_SOFTEN_SCALE = 32;
function packCompositeUniforms(state, out = new Float32Array(COMPOSITE_UNIFORM_FLOATS)) {
  ...
  const clamp012 = (value) => Math.min(1, Math.max(0, value));
  ...
  out[13] = clamp012(n("rgbShift", 0) * ABERRATION_EDGE_SOFTEN_SCALE);
  out[14] = clamp012(n("diffusion", 0));
  ...
  out[22] = 0;
  out[23] = 0;
  out[24] = clamp012(n("opticalDirectTransmission", 1));
  out[25] = clamp012(n("opticalBlackRetention", 1));
  out[26] = clamp012(n("opticalScatterStrength", 0));
  out[27] = clamp012(n("opticalHighlightReactivity", 0));
  out[28] = clamp012(n("opticalWarmScatter", 0));
  out[29] = clamp012(n("opticalSpectralTail", 0));
  out[30] = 0;
  out[31] = 0;
  return out;
}
...
// src/webgpu/crossFilterState.ts
var CROSS_FILTER_MIN_SPACING_EPSILON = 1e-4;
var CROSS_FILTER_TEMPORAL_REFERENCE_FPS = 24;
var CROSS_FILTER_TEMPORAL_REFERENCE_DECAY = 0.82;
function isCrossFilterHardModeActive(crossFilterStrength, crossFilterHardMode) {
  return crossFilterStrength > 0 && crossFilterHardMode >= 0.5;
}
function effectiveDiffusionAmount(userDiffusion, hardModeActive) {
  if (hardModeActive) return 0;
  if (!Number.isFinite(userDiffusion)) return 0;
  return Math.min(1, Math.max(0, userDiffusion));
}
function computeCrossFilterTemporalDecay(deltaSeconds, referenceFps = CROSS_FILTER_TEMPORAL_REFERENCE_FPS, referenceDecay = CROSS_FILTER_TEMPORAL_REFERENCE_DECAY) {
...
function shouldResetCrossFilterHistory(prev, next) {
  if (next.hardMode !== prev.hardMode) return true;
  if (next.strength === 0 && prev.strength !== 0) return true;
  if (Math.abs(next.minSpacing - prev.minSpacing) >= CROSS_FILTER_MIN_SPACING_EPSILON) {
    return true;
  }
  return false;
}

// src/webgpu/rayAngleOptics.ts
var RAY_ANGLE_FALLBACK_HFOV_DEG = 65;
var RAY_ANGLE_FOV_MIN_DEG = 1;
var RAY_ANGLE_FOV_MAX_DEG = 178;
var RAY_ANGLE_REFERENCE_TAN_HALF_HFOV = Math.tan(
  RAY_ANGLE_FALLBACK_HFOV_DEG * Math.PI / 360
);
var DEFAULT_RAY_ANGLE_INNER_THRESHOLD = 0.1;
function finitePositive(value) {
  return typeof value === "number" && Number.isFinite(value) && value > 0;
}
function sourceAspectY(width, height) {
  const w = finitePositive(width) ? width : 1;
  const h = finitePositive(height) ? height : w;
  return h / Math.max(w, 1);
}
function tanHalfFovFromDeg(fovDeg) {
  if (typeof fovDeg !== "number" || !Number.isFinite(fovDeg) || fovDeg < RAY_ANGLE_FOV_MIN_DEG || fovDeg > RAY_ANGLE_FOV_MAX_DEG) {
    return null;
  }
  return Math.tan(fovDeg * Math.PI / 360);
}
function tanHalfFovFromFocalPx(focalPx, imageExtentPx) {
  if (!finitePositive(focalPx) || !finitePositive(imageExtentPx)) {
    return null;
  }
  return imageExtentPx * 0.5 / focalPx;
}
function resolveRayAngleOptics(optics, imageWidth, imageHeight) {
  const aspectY = sourceAspectY(imageWidth, imageHeight);
  const aspectX = 1 / Math.max(aspectY, 1e-6);
  let tanHalfFovX = tanHalfFovFromDeg(optics?.fovXDeg) ?? tanHalfFovFromFocalPx(optics?.fxPx, imageWidth);
  let tanHalfFovY = tanHalfFovFromDeg(optics?.fovYDeg) ?? tanHalfFovFromFocalPx(optics?.fyPx, imageHeight);
...
function rayAngleMaskValue(options) {
  const resolved = options.optics && "tanHalfFovX" in options.optics ? options.optics : resolveRayAngleOptics(
    options.optics ?? null,
    options.imageWidth,
    options.imageHeight
  );
  ...
  const referenceIncidence = 1 - 1 / Math.sqrt(
  ...
  const gamma = Math.max(options.gamma ?? 1.4, 1e-3);
...
// src/webgpu/passes/pyramid.ts
function computeMipWeights(radius, levels) {
  const weights = [];
  for (let i = 0; i < levels; i++) {
...
function ensurePyramidLevels(pool, labelPrefix, levels, width, height) {
  const out = [];
  for (let i = 0; i < levels; i++) {
    const divisor = 2 ** (i + 1);
...
function renderPyramidChain(encoder, label, prefilterPipeline, prefilterParamsBuffer, sourceView, levels, pyramid, radius, deps) {
  const { device, layout, sampler, offscreenFlagsBindGroup, downsamplePipeline, upsampleAddPipeline } = deps;
...
// src/webgpu/passes/bloom.ts
function renderBloomDepthPrefilter(encoder, sourceView, gain, rayAngleGain, rayAngleGamma, rayAngleInnerThreshold, fieldPsfGain, fieldPsfRadiusPx, optics, deps) {
  const {
    device,
    pool,
    width,
...
// src/webgpu/passes/halation.ts
function renderHalationDepthPrefilter(encoder, sourceView, gain, rayAngleGain, rayAngleGamma, rayAngleInnerThreshold, fieldPsfGain, fieldPsfRadiusPx, optics, deps) {
  const {
    device,
    pool,
    width,
...
// src/webgpu/passes/diffusion.ts
function renderDiffusionDepthPrefilter(encoder, sourceView, depthMistGain, rayAngleGain, rayAngleGamma, rayAngleInnerThreshold, fieldPsfGain, fieldPsfRadiusPx, optics, deps) {
  const {
    device,
    pool,
    width,
...
function renderDiffusionPyramid(encoder, sourceView, levels, diffusionPyramid, deps) {
  const {
    device,
    layout,
    sampler,
...
// src/webgpu/passes/lightShafts.ts
var LIGHTSHAFTS_RES_DIVISOR = 4;
var LIGHTSHAFTS_DENSITY = 0.98;
var LIGHTSHAFTS_EXPOSURE = 0.38;
function renderLightShafts(encoder, sourceTexture, deps) {
  const {
    device,
    pool,
    width,
...
// src/webgpu/passes/haloPrism.ts
function renderHaloPrism(encoder, sceneTexture, sourceSeedTexture, deps) {
  const {
    device,
    pool,
    width,
...
// src/webgpu/passes/crossFilter.ts
var CROSS_FILTER_SPACING_RADIUS_MAX_PX = 48;
var CROSS_FILTER_SPACING_RADIUS_STEP_PX = 24;
var CROSS_FILTER_THRESHOLD_HARD_BASELINE = 0.7;
var CROSS_FILTER_THRESHOLD_CONTROL_BASELINE = 0.92;
var CROSS_FILTER_HISTORY_SLOTS = 2;
var WEBGPU_CROSS_FILTER_TEMPORAL_HOLD_ENABLED = false;
var CENTRAL_BLOOM_RADIUS = 0.5;
var DEFAULT_CROSS_FILTER_DEPTH_GAIN = 0.25;
var DEFAULT_CROSS_FILTER_ANGLE_GAIN = 0.35;
var DEFAULT_CROSS_FILTER_EDGE_LENGTH_GAIN = 0.45;
var DEFAULT_CROSS_FILTER_EDGE_STRENGTH_GAIN = 0.25;
function smoothstep01(value) {
  const clamped = Math.min(1, Math.max(0, value));
  return clamped * clamped * (3 - 2 * clamped);
}
function computeCrossFilterEffectiveThreshold(threshold, hardModeActive) {
  if (!hardModeActive) {
    return threshold;
  }
  return Math.min(
    ...
    Math.max(
      0,
      threshold - (CROSS_FILTER_THRESHOLD_CONTROL_BASELINE - CROSS_FILTER_THRESHOLD_HARD_BASELINE)
    )
  );
}
function computeCrossFilterSpacingRadiusPx(minSpacing, minSpacingMin, minSpacingMax) {
  const clamped = Math.min(
    minSpacingMax,
    Math.max(minSpacingMin, minSpacing)
  );
  let extraRadius = 0;
  for (let stepStart = minSpacingMin; stepStart < minSpacingMax; stepStart += 1) {
    extraRadius += CROSS_FILTER_SPACING_RADIUS_STEP_PX * smoothstep01(clamped - stepStart);
  }
  return Math.round(CROSS_FILTER_SPACING_RADIUS_MAX_PX + extraRadius);
}
function renderCentralBloom(encoder, heldPeakTexture, deps) {
  const {
    device,
    pool,
    width,
...
function renderCrossFilter(encoder, sourceTexture, deps) {
  const {
    device,
    pool,
    width,
  ...
  const streakTextures = Array.from(
    { length: maxStreaks },
    (_, index) => pool.get(`rt.crossfilter.streak.${index}`, {
      width: halfWidth,
      height: halfHeight,
      format: "rgba16float"
    })
  ...
  const effectiveSizeLimit = hardModeActive ? 1 : sizeLimit;
  const effectiveRandomness = hardModeActive ? 1 : randomness;
  ...
  if (hardModeActive && WEBGPU_CROSS_FILTER_TEMPORAL_HOLD_ENABLED) {
    ...
    const writeIndex = peakHistoryWriteIndex % CROSS_FILTER_HISTORY_SLOTS;
    const prevIndex = (writeIndex + CROSS_FILTER_HISTORY_SLOTS - 1) % CROSS_FILTER_HISTORY_SLOTS;
    const prevTexture = peakHistoryFilledFrames > 0 ? historyTextures[prevIndex] : crossFilter.blackTexture;
    const writeTexture = historyTextures[writeIndex];
    const temporalDeltaSeconds = lastHistoryTime === null ? 1 / CROSS_FILTER_TEMPORAL_REFERENCE_FPS : time - lastHistoryTime;
    ...
    peakHistoryWriteIndex = (writeIndex + 1) % CROSS_FILTER_HISTORY_SLOTS;
  ...
  {
    const centralBloomView = centralBloomTexture ? centralBloomTexture.createView() : blackView;
    const blendEntries = [
...
// src/webgpu/passes/motionBlur.ts
function activeMotionBlurFrames(shutterAngle) {
  return activeMotionBlurFramesForShutter(
    shutterAngle,
    MOTION_BLUR_RING_SLOTS
  );
}
function computeMotionBlurWeights2(shutterAngle, activeFrames, validSlots) {
...
function renderMotionBlurChain(encoder, postCompositeView, swapView, readbackView, shutterAngle, deps) {
  const {
    device,
    ringBuffer,
  ...
  const prevSlot = ringBuffer.validSlots > 0 ? (
  ...
  const validSlots = ringBuffer.validSlots;
  const hasPrev = validSlots > 1 ? 1 : 0;
  const prevSlotIndex = (nextSlot - 1 + MOTION_BLUR_RING_SLOTS) % MOTION_BLUR_RING_SLOTS;
  void prevSlot;
  ...
  const weights = computeMotionBlurWeights2(
    shutterAngle,
    activeFrames,
    validSlots
  );
  const oldestSlot = (nextSlot - (activeFrames - 1) + MOTION_BLUR_RING_SLOTS * 2) % MOTION_BLUR_RING_SLOTS;
...
// src/webgpu/WebGPUBackend.ts
var IDENTITY_LUT_SIZE = 33;
var BLOOM_LEVELS = 5;
var HALATION_LEVELS = 6;
var DIFFUSION_LEVELS = 3;
var BLOOM_PARAMS_BYTES = 16;
var HALATION_PARAMS_BYTES = 32;
var DETAIL_SOFTNESS_PARAMS_BYTES = 48;
var PYRAMID_LEVEL_UNIFORM_BYTES = 16;
var MOTIONBLUR_FEEDBACK_UNIFORM_BYTES = 16;
var MOTIONBLUR_BLEND_UNIFORM_BYTES = 48;
var MOTIONBLUR_BLEND_UNIFORM_FLOATS = MOTIONBLUR_BLEND_UNIFORM_BYTES / 4;
var CROSS_FILTER_PARAMS_BYTES = 16;
var CROSS_FILTER_SPACING_MAX_BYTES = 32;
var CROSS_FILTER_STREAK_BYTES = 96;
var CROSS_FILTER_MAX_STREAKS = 4;
var CROSS_FILTER_MIN_SPACING_MIN = 1;
var CROSS_FILTER_MIN_SPACING_MAX = 10;
var CENTRAL_BLOOM_LEVELS = 4;
var LIGHTSHAFTS_PARAMS_BYTES = 32;
var LIGHTSHAFTS_BLEND_PARAMS_BYTES = 16;
var HALO_PRISM_PARAMS_BYTES = 80;
var HALO_PRISM_PARAMS_FLOATS = HALO_PRISM_PARAMS_BYTES / 4;
var DEFAULT_BLOOM_THRESHOLD = 0.8;
var DEFAULT_BLOOM_KNEE = 0.5;
var DEFAULT_BLOOM_RADIUS = 0.5;
var DEFAULT_HALATION_THRESHOLD = 0.6;
var DEFAULT_HALATION_KNEE = 0.5;
var DEFAULT_HALATION_RADIUS = 0.5;
var DEFAULT_HALATION_COLOR = [0.91, 0.063, 0.125];
var DEFAULT_DEPTH_RAY_ANGLE_GAMMA = 1.4;
var DEFAULT_DEPTH_MIST_RAY_ANGLE_GAIN = 0.35;
var DEFAULT_DEPTH_BLOOM_RAY_ANGLE_GAIN = 0.25;
var DEFAULT_DEPTH_HALATION_RAY_ANGLE_GAIN = 0.18;
var DEFAULT_DEPTH_MIST_FIELD_PSF_GAIN = 1;
var DEFAULT_DEPTH_BLOOM_FIELD_PSF_GAIN = 1;
var DEFAULT_DEPTH_HALATION_FIELD_PSF_GAIN = 1;
var DEFAULT_DEPTH_MIST_FIELD_PSF_RADIUS_PX = 18;
var DEFAULT_DEPTH_BLOOM_FIELD_PSF_RADIUS_PX = 9;
var DEFAULT_DEPTH_HALATION_FIELD_PSF_RADIUS_PX = 12;
var WebGPUBackend = class _WebGPUBackend {
  ctx;
  capabilities;
  modules;
  pool;
  ...
  diffusionDepthPrefilterBuffer;
  diffusionDepthPrefilterScratch;
  bloomDepthPrefilterBuffer;
  bloomDepthPrefilterScratch;
  halationDepthPrefilterBuffer;
  halationDepthPrefilterScratch;
  bloomPyramid;
  halationPyramid;
  diffusionPyramid;
  centralBloomPyramid;
   ...
   */
  depthTexture;
  gradeScratch = new Float32Array(GRADE_UNIFORM_FLOATS);
  compositeScratch = new Float32Array(COMPOSITE_UNIFORM_FLOATS);
  detailSoftnessScratch = new Float32Array(DETAIL_SOFTNESS_PARAMS_BYTES / 4);
  bloomParamsScratch = new Float32Array(BLOOM_PARAMS_BYTES / 4);
  halationParamsScratch = new Float32Array(HALATION_PARAMS_BYTES / 4);
  motionblurFeedbackScratch = new Float32Array(4);
  motionblurBlendScratch = new Float32Array(MOTIONBLUR_BLEND_UNIFORM_FLOATS);
  /** Compare present uniform: 2 vec4 = 8 floats = 32 B. */
  compareSourceBuffer;
  compareSourceScratch = new Float32Array(8);
  mediaTexture = null;
  ...
  lastCrossFilterHistoryTime = null;
  lastCrossFilterStrength = 0;
  lastCrossFilterHardMode = 0;
  lastCrossFilterMinSpacing = 0;
  constructor(ctx, modules, pool, pipelines, layouts, displayFlagsBuffer, offscreenFlagsBuffer, crossFilterFlagsBuffer, displayFlagsBindGroup, offscreenFlagsBindGroup, crossFilterFlagsBindGroup, gradeBuffer, compositeBuffer, detailSoftnessBuffer, bloomParamsBuffer, halationParamsBuffer, bloomPyramid, halationPyramid, diffusionPyramid, centralBloomPyramid, motionblurFeedbackBuffer, motionblurBlendBuffer, crossFilter, lightShafts, haloPrism, sampler, grainSampler, grainTexture, lut1Texture, lut2Texture, ringBuffer, compareSourceBuffer) {
    this.ctx = ctx;
  ...
  static async create(canvas, opts = {}) {
    ...
    const { device } = ctx;
    const make = async (label, code) => ctx.withValidationScope(() => device.createShaderModule({ label, code }));
    const modules = {
    ...
    const makePyramid = (label, levels) => {
      const downsample = [];
      const upsample = [];
      const downsampleScratch = [];
      const upsampleScratch = [];
      for (let i = 0; i < levels; i++) {
        downsample.push(
          device.createBuffer({
            label: `${label}.downsample.${i}`,
  ...
  setMediaFromVideoElement(video) {
   ...
   */
  setComparePair(enabled, _paramsA, _paramsB) {
  ...
  reportFatalContextLoss(reason, error) {
  ...
  refreshLiveVideoTexture() {
    ...
    try {
      ...
      if (width !== this.frameState.imgResX || height !== this.frameState.imgResY) {
        this.setImageResolution(width, height);
      }
    } catch (error) {
  ...
  getActiveMediaTexture(allowPlaceholder) {
  ...
  paramNumber(key, fallback) {
    const v = this.frameState.params[key];
    return typeof v === "number" ? v : fallback;
  }
  paramString(key, fallback) {
    const v = this.frameState.params[key];
  ...
  uploadFrameUniforms(suppressDiffusion) {
    ...
    const halationColor = halationRawColor.length > 0 ? hexToRgbTriple(halationRawColor) : DEFAULT_HALATION_COLOR;
  ...
  static computeMipWeights(radius, levels) {
    return computeMipWeights(radius, levels);
  }
  ensurePyramidLevels(labelPrefix, levels) {
    return ensurePyramidLevels(
      this.pool,
      labelPrefix,
      levels,
      this._width,
  ...
  renderPyramidChain(encoder, label, prefilterPipeline, prefilterParamsBuffer, sourceView, levels, pyramid, radius) {
    return renderPyramidChain(
      encoder,
      label,
      prefilterPipeline,
   ...
   */
  renderDiffusionDepthPrefilter(encoder, sourceView, depthMistGain, rayAngleGain, rayAngleGamma, rayAngleInnerThreshold, fieldPsfGain, fieldPsfRadiusPx, optics) {
    return renderDiffusionDepthPrefilter(
      encoder,
      sourceView,
      depthMistGain,
      rayAngleGain,
      ...
      optics,
      {
        ...
        sampler: this.sampler,
        offscreenFlagsBindGroup: this.offscreenFlagsBindGroup,
        packRayAngleOptics: (target, offset, o, innerThreshold) => this.packRayAngleOptics(target, offset, o, innerThreshold)
      }
    );
  }
  /**
   ...
   */
  renderBloomDepthPrefilter(encoder, sourceView, gain, rayAngleGain, rayAngleGamma, rayAngleInnerThreshold, fieldPsfGain, fieldPsfRadiusPx, optics) {
    return renderBloomDepthPrefilter(
      encoder,
      sourceView,
      gain,
      rayAngleGain,
   ...
   */
  renderHalationDepthPrefilter(encoder, sourceView, gain, rayAngleGain, rayAngleGamma, rayAngleInnerThreshold, fieldPsfGain, fieldPsfRadiusPx, optics) {
    return renderHalationDepthPrefilter(
      encoder,
      sourceView,
      gain,
      rayAngleGain,
  ...
  renderDiffusionPyramid(encoder, sourceView, levels) {
    return renderDiffusionPyramid(encoder, sourceView, levels, this.diffusionPyramid, {
      device: this.ctx.device,
      layout: this.layouts.pyramid,
      sampler: this.sampler,
      offscreenFlagsBindGroup: this.offscreenFlagsBindGroup,
   ...
   */
  renderLightShafts(encoder, sourceTexture) {
    return renderLightShafts(encoder, sourceTexture, {
      device: this.ctx.device,
      pool: this.pool,
      width: this._width,
      height: this._height,
  ...
  renderHaloPrism(encoder, sceneTexture, sourceSeedTexture) {
    return renderHaloPrism(encoder, sceneTexture, sourceSeedTexture, {
      device: this.ctx.device,
      pool: this.pool,
      width: this._width,
      height: this._height,
      ...
      packRayAngleOptics: (target, offset, optics, innerThreshold) => this.packRayAngleOptics(target, offset, optics, innerThreshold)
    });
  }
  renderCrossFilter(encoder, sourceTexture) {
    const result = renderCrossFilter(encoder, sourceTexture, {
      device: this.ctx.device,
      pool: this.pool,
      width: this._width,
      height: this._height,
  ...
  renderFrame(allowPlaceholderMedia) {
    ...
    if (detailSoftnessUniforms.effectiveDetailSoftness > 1e-4) {
    ...
    const bloomSourceView = depthGlowActive ? this.renderBloomDepthPrefilter(
      encoder,
      opticalSourceView,
      depthGlowGain,
    ...
    const halationSourceView = depthGlowActive ? this.renderHalationDepthPrefilter(
      encoder,
      opticalSourceView,
      depthGlowGain,
    ...
    if (diffusionAmount > 0) {
      ...
      const pyramidInputView = depthMistActive ? this.renderDiffusionDepthPrefilter(
        encoder,
        opticalSourceView,
        depthMistGain,
    ...
    const readbackView = this.readbackEnabled ? this.pool.get("rt.present.readback", {
      width: this._width,
      height: this._height,
      format: this.ctx.canvasFormat,
      usage: GPUTextureUsage.RENDER_ATTACHMENT | GPUTextureUsage.COPY_SRC
    ...
    if (this.frameState.compareEnabled) {
      ...
      this.compareSourceScratch[5] = this.frameState.splitPosition >= 0 ? this.frameState.splitPosition : 0.5;
      this.compareSourceScratch[6] = 2;
